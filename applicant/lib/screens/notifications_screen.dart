...
class _NotificationsScreenState extends State<NotificationsScreen> {
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return const _EmptyNotifications(
                message:
                'Notifications could not be loaded. Pull down to refresh later.',
              );
            }
            ...
            final all =
            docs.map(NotificationModel.fromFirestore).toList();
            ...
            final matches = all
                .where(
                  (n) =>
              n.type.toLowerCase().contains('match') ||
                  n.type.toLowerCase().contains('result'),
            )
                .length;
            final verification = all
                .where(
                  (n) =>
              n.type.toLowerCase().contains('verification') ||
                  n.type.toLowerCase().contains('application'),
            )
                .length;
            ...
            final filtered = all.where((n) {
              ...
              if (_filter == 'match') {
                return t.contains('match') || t.contains('result');
              }
              if (_filter == 'verification') {
                return t.contains('verification') ||
              ...
              children: [
                ...
                Expanded(
                  child: filtered.isEmpty
                      ? const _EmptyNotifications(
                    message: 'No notifications in this filter.',
                  )
                      : ListView.builder(
                    padding:
  ...
  Widget _chip(String key, String label) => ChoiceChip(
    ...
    selectedColor: AppColors.lightPurpleBackground,
    labelStyle: AppTextStyles.captionText.copyWith(
      color:
      _filter == key ? AppColors.deepPurple : AppColors.secondaryText,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Unread, result and verification updates will appear here.',
