...
('Booked', Color(0xFFF4B64B)),
('Allocated', Color(0xFF9AA1AD)),
...
static const List<String> _blockE = [
'E-101',
];

static const List<String> _blockG = [
'G-105',
];

static const List<String> _blockP = [
'P-101',
];
...
selectedPlotNumber: selectedPlotNumber,
hoveredPlotNumber: hoveredPlotNumber,
dimmed: activeBlock != 'All' && activeBlock != 'E',
onPlotTap: onPlotTap,
onPlotHover: onPlotHover,
),
),
...
selectedPlotNumber: selectedPlotNumber,
hoveredPlotNumber: hoveredPlotNumber,
dimmed: activeBlock != 'All' && activeBlock != 'G',
onPlotTap: onPlotTap,
onPlotHover: onPlotHover,
),
),
...
selectedPlotNumber: selectedPlotNumber,
hoveredPlotNumber: hoveredPlotNumber,
dimmed: activeBlock != 'All' && activeBlock != 'P',
onPlotTap: onPlotTap,
onPlotHover: onPlotHover,
),
),
...
top: 88,
left: 420,
child: _RoadLabel(text: 'MAIN BOULEVARD'),
),
const Positioned(
left: 5,
top: 300,
...
child: InkWell(
onTap: plot == null || !isAvailable ? null : onTap,
borderRadius: BorderRadius.circular(7),
